...
export default function CookiePolicyPage() {
  return (
    <PolicyLayout title="Cookie Policy" lastUpdated="29 May 2026">
      <p>
        This Cookie Policy explains how ULTRASENS LT MB, trading as UltraSensSkin, uses cookies and similar
        technologies on www.ultrasensskin.com.
      </p>
      <p>The Website is operated by:</p>
      <ContactBlock />
      <p>
        In this Cookie Policy, &ldquo;UltraSensSkin&rdquo;, &ldquo;we&rdquo;, &ldquo;us&rdquo; or
        &ldquo;our&rdquo; means ULTRASENS LT MB. &ldquo;You&rdquo; or &ldquo;your&rdquo; means any visitor,
      ...
      <ul>
        <li>first-party cookies, set directly by UltraSensSkin; or</li>
      ...
      <p>
        8.2 These cookies may be set by UltraSensSkin or by third-party advertising and marketing partners.
      </p>
      <p>
      ...
      <p>9.4 UltraSensSkin does not store your full card number or full card security code.</p>
